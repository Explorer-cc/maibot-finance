...
首个可用交付按 M0 -> M2 推进：**M0 已于 2026-07-29 完成真实验证**，即 QQ -> NapCat -> MaiBot -> DeepSeek -> QQ 回复的最小闭环。下一阶段 M2 固化“爱叭叭的毒舌损友”人格，并以审核后的 crypto 机制科普资料验证静态检索。M2 之后才扩展其余静态资料域。实时数据、交易能力、聚合模型网关、完整记忆治理和完整 Runbook 均不属于 v1。
